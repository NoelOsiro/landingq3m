    ...
    <AnimatedSection>
          <div className='flex lg:h-[600px]' >
            <div className="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
              <div>
                <h2 className="text-3xl font-semibold md:text-4xl">Welcome to <span className="text-indigo-600">Q3M Wanda Solutions</span></h2>
                <p className="mt-2 text-sm text-gray-500 md:text-base">Empowering businesses with innovative solutions for the challenges of tomorrow.</p>
